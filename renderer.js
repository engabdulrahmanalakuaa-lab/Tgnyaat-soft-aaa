...
let taxRate = 0;
let currentOrderType = 'local';   // متغير جديد لتحديد نوع الطلب (محلي/سفري)
...
async function renderPOS() {
    ...
    `;
    // تحديث حالة الأزرار حسب currentOrderType
...
async function checkoutPOS() {
    ...
    const result = await ipcRenderer.invoke('create-order', {
        ...
        order_type: currentOrderType   // إرسال نوع الطلب
    });
